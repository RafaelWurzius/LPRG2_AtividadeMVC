...
class Database extends PDO
{
  ...
  public function __construct()
  {
    ...
    // $this->conn = new PDO("pgsql:host=$this->DB_HOST;dbname=$this->DB_NAME;port=$this->DB_PORT;user=$this->DB_USER;password=$this->DB_PASSWORD");
    $this->conn = new PDO("sqlite:../Application/core/db/database.db");
  }
